#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/episode_metrics.py.

Legacy flat bare-name imports (``import episode_metrics``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.episode_metrics`` directly.
"""
import os
import sys

try:
    import drl_agent.training.episode_metrics as _impl
