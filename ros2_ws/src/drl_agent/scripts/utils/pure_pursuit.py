#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/common/pure_pursuit.py.

Legacy flat bare-name imports (``import pure_pursuit``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.common.pure_pursuit`` directly.
"""
import os
import sys

try:
    import drl_agent.common.pure_pursuit as _impl
