#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/replay/buffer.py.

Legacy flat bare-name imports (``import buffer``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.replay.buffer`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.replay.buffer as _impl
