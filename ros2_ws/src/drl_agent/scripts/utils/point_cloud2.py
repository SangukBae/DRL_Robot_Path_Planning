#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/common/point_cloud2.py.

Legacy flat bare-name imports (``import point_cloud2``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.common.point_cloud2`` directly.
"""
import os
import sys

try:
    import drl_agent.common.point_cloud2 as _impl
