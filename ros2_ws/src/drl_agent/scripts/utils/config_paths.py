#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/config/paths.py.

Legacy flat bare-name imports (``import config_paths``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.config.paths`` directly.
"""
import os
import sys
