#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/common/file_manager.py.

Legacy flat bare-name imports (``import file_manager``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.common.file_manager`` directly.
"""
import os
import sys

try:
    import drl_agent.common.file_manager as _impl
