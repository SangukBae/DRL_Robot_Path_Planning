#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/aux_ablation_logging.py.

Legacy flat bare-name imports (``import aux_ablation_logging``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.aux_ablation_logging`` directly.
"""
import os
import sys

try:
    import drl_agent.training.aux_ablation_logging as _impl
