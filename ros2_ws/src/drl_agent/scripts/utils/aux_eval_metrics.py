#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/aux_eval_metrics.py.

Legacy flat bare-name imports (``import aux_eval_metrics``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.aux_eval_metrics`` directly.
"""
import os
import sys

try:
    import drl_agent.training.aux_eval_metrics as _impl
