#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/common/geometry_utils.py.

Legacy flat bare-name imports (``import geometry_utils``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.common.geometry_utils`` directly.
"""
import os
import sys

try:
    import drl_agent.common.geometry_utils as _impl
