#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/evaluation/sim_validation.py.

Legacy flat bare-name imports (``import sim_validation``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.evaluation.sim_validation`` directly.
"""
import os
import sys

try:
    import drl_agent.evaluation.sim_validation as _impl
