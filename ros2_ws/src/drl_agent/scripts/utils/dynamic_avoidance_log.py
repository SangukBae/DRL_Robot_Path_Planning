#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/dynamic_avoidance_log.py.

Legacy flat bare-name imports (``import dynamic_avoidance_log``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.dynamic_avoidance_log`` directly.
"""
import os
import sys

try:
    import drl_agent.training.dynamic_avoidance_log as _impl
