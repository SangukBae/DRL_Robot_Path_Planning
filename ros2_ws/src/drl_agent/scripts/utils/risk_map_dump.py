#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/evaluation/risk_map_dump.py.

Legacy flat bare-name imports (``import risk_map_dump``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.evaluation.risk_map_dump`` directly.
"""
import os
import sys

try:
    import drl_agent.evaluation.risk_map_dump as _impl
