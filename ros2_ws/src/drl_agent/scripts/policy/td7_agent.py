#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/algorithms/td7/agent.py.

Legacy flat bare-name imports (``import td7_agent``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.algorithms.td7.agent`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.algorithms.td7.agent as _impl
