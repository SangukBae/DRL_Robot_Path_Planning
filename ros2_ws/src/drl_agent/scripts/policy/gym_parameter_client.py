#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/gym_parameter_client.py.

Legacy flat bare-name imports (``import gym_parameter_client``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.gym_parameter_client`` directly.
"""
import os
import sys

try:
    import drl_agent.training.gym_parameter_client as _impl
