#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/algorithms/a3c/agent.py.

Legacy flat bare-name imports (``import a3c_agent``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.algorithms.a3c.agent`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.algorithms.a3c.agent as _impl
