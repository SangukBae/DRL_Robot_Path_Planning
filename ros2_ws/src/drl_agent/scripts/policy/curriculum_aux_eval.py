#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/curriculum/aux_eval.py.

Legacy flat bare-name imports (``import curriculum_aux_eval``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.curriculum.aux_eval`` directly.
"""
import os
import sys

try:
    import drl_agent.training.curriculum.aux_eval as _impl
