#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/checkpointing/tqc_io.py.

Legacy flat bare-name imports (``import tqc_io``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.checkpointing.tqc_io`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.checkpointing.tqc_io as _impl
