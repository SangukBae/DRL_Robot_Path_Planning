#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/train_tqc_curriculum.py.

Legacy flat bare-name imports (``import train_tqc_curriculum_agent``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.train_tqc_curriculum`` directly.
"""
import os
import sys

try:
    import drl_agent.training.train_tqc_curriculum as _impl
