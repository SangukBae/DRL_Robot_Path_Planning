#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/train_rl.py.

Legacy flat bare-name imports (``import train_rl``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.train_rl`` directly.
"""
import os
import sys

try:
    import drl_agent.training.train_rl as _impl
