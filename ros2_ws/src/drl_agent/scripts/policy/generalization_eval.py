#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/evaluation/generalization_eval.py.

Legacy flat bare-name imports (``import generalization_eval``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.evaluation.generalization_eval`` directly.
"""
import os
import sys

try:
    import drl_agent.evaluation.generalization_eval as _impl
