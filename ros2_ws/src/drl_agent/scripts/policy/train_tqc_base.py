#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/train_tqc_base.py.

Legacy flat bare-name imports (``import train_tqc_base``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.train_tqc_base`` directly.
"""
import os
import sys

try:
    import drl_agent.training.train_tqc_base as _impl
