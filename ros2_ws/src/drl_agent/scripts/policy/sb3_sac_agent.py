#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/algorithms/sb3/sac.py.

Legacy flat bare-name imports (``import sb3_sac_agent``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.algorithms.sb3.sac`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.algorithms.sb3.sac as _impl
