#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/networks/action_risk_head.py.

Legacy flat bare-name imports (``import action_risk_head``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.networks.action_risk_head`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.networks.action_risk_head as _impl
