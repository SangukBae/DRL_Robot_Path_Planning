#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/evaluation/real_policy_runner.py.

Legacy flat bare-name imports (``import real_policy_runner``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.evaluation.real_policy_runner`` directly.
"""
import os
import sys

try:
    import drl_agent.evaluation.real_policy_runner as _impl
