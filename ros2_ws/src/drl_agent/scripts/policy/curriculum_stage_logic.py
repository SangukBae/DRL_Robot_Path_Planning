#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/curriculum/stage_logic.py.

Legacy flat bare-name imports (``import curriculum_stage_logic``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.curriculum.stage_logic`` directly.
"""
import os
import sys

try:
    import drl_agent.training.curriculum.stage_logic as _impl
