#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/networks/aux_losses.py.

Legacy flat bare-name imports (``import aux_prediction_losses``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.networks.aux_losses`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.networks.aux_losses as _impl
