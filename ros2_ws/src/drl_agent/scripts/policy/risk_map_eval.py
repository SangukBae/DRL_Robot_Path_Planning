#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/evaluation/risk_map_eval.py.

Legacy flat bare-name imports (``import risk_map_eval``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.evaluation.risk_map_eval`` directly.
"""
import os
import sys

try:
    import drl_agent.evaluation.risk_map_eval as _impl
