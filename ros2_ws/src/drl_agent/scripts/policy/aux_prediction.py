#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/networks/aux_prediction.py.

Legacy flat bare-name imports (``import aux_prediction``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.networks.aux_prediction`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.networks.aux_prediction as _impl
