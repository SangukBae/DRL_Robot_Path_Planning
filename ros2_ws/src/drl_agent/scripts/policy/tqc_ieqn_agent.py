#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/algorithms/tqc_ieqn/agent.py.

Legacy flat bare-name imports (``import tqc_ieqn_agent``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.algorithms.tqc_ieqn.agent`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.algorithms.tqc_ieqn.agent as _impl
