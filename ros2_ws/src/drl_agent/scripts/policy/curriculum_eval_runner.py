#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/training/curriculum/eval_runner.py.

Legacy flat bare-name imports (``import curriculum_eval_runner``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.training.curriculum.eval_runner`` directly.
"""
import os
import sys

try:
    import drl_agent.training.curriculum.eval_runner as _impl
