#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/rl/networks/tqc.py.

Legacy flat bare-name imports (``import tqc_networks``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.rl.networks.tqc`` directly.
"""
import os
import sys

try:
    import drl_agent.rl.networks.tqc as _impl
