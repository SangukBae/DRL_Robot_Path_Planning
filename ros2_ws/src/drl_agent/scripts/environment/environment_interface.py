#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/environment_interface.py.

Legacy flat bare-name imports (``import environment_interface``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.environment_interface`` directly.
"""
import os
import sys

try:
    import drl_agent.env.environment_interface as _impl
