#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/observation/obs_time_context.py.

Legacy flat bare-name imports (``import obs_time_context``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.observation.obs_time_context`` directly.
"""
import os
import sys

try:
    import drl_agent.env.observation.obs_time_context as _impl
