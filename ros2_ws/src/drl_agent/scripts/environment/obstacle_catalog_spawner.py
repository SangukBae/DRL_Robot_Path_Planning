#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/spawning/obstacle_catalog_spawner.py.

Legacy flat bare-name imports (``import obstacle_catalog_spawner``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.spawning.obstacle_catalog_spawner`` directly.
"""
import os
import sys

try:
    import drl_agent.env.spawning.obstacle_catalog_spawner as _impl
