#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/simulation/localization_noise.py.

Legacy flat bare-name imports (``import localization_noise``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.simulation.localization_noise`` directly.
"""
import os
import sys

try:
    import drl_agent.env.simulation.localization_noise as _impl
