#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/spawning/goal_sampler.py.

Legacy flat bare-name imports (``import goal_sampler``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.spawning.goal_sampler`` directly.
"""
import os
import sys

try:
    import drl_agent.env.spawning.goal_sampler as _impl
