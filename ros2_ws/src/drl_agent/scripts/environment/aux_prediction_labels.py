#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/observation/aux_prediction_labels.py.

Legacy flat bare-name imports (``import aux_prediction_labels``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.observation.aux_prediction_labels`` directly.
"""
import os
import sys

try:
    import drl_agent.env.observation.aux_prediction_labels as _impl
