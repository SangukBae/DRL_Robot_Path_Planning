#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/simulation/environment.py.

Legacy flat bare-name imports (``import environment``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.simulation.environment`` directly.
"""
import os
import sys

try:
    import drl_agent.env.simulation.environment as _impl
