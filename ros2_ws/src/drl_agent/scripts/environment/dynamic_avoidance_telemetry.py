#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/humans/dynamic_avoidance_telemetry.py.

Legacy flat bare-name imports (``import dynamic_avoidance_telemetry``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.humans.dynamic_avoidance_telemetry`` directly.
"""
import os
import sys

try:
    import drl_agent.env.humans.dynamic_avoidance_telemetry as _impl
