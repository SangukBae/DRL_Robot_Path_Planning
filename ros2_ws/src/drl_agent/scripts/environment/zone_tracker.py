#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/simulation/zone_tracker.py.

Legacy flat bare-name imports (``import zone_tracker``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.simulation.zone_tracker`` directly.
"""
import os
import sys

try:
    import drl_agent.env.simulation.zone_tracker as _impl
