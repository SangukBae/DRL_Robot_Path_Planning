#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/rewards/reward_calculator.py.

Legacy flat bare-name imports (``import reward_calculator``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.rewards.reward_calculator`` directly.
"""
import os
import sys

try:
    import drl_agent.env.rewards.reward_calculator as _impl
