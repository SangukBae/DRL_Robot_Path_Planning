#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/simulation/map_layout_runtime.py.

Legacy flat bare-name imports (``import map_layout_runtime``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.simulation.map_layout_runtime`` directly.
"""
import os
import sys

try:
    import drl_agent.env.simulation.map_layout_runtime as _impl
