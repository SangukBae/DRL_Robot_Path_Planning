#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/spawning/start_sampler.py.

Legacy flat bare-name imports (``import start_sampler``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.spawning.start_sampler`` directly.
"""
import os
import sys

try:
    import drl_agent.env.spawning.start_sampler as _impl
