#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/curriculum/environment_curriculum.py.

Legacy flat bare-name imports (``import environment_curriculum``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.curriculum.environment_curriculum`` directly.
"""
import os
import sys

try:
    import drl_agent.env.curriculum.environment_curriculum as _impl
