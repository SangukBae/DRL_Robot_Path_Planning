#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/observation/observation_builder.py.

Legacy flat bare-name imports (``import observation_builder``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.observation.observation_builder`` directly.
"""
import os
import sys

try:
    import drl_agent.env.observation.observation_builder as _impl
