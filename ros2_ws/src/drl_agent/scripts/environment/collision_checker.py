#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/simulation/collision_checker.py.

Legacy flat bare-name imports (``import collision_checker``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.simulation.collision_checker`` directly.
"""
import os
import sys

try:
    import drl_agent.env.simulation.collision_checker as _impl
