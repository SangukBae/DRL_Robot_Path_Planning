#!/usr/bin/env python3
"""Compatibility shim — canonical module moved to drl_agent/env/humans/human_motion_manager.py.

Legacy flat bare-name imports (``import human_motion_manager``) keep working: this file
aliases itself to the package module. New code should import
``drl_agent.env.humans.human_motion_manager`` directly.
"""
import os
import sys

try:
    import drl_agent.env.humans.human_motion_manager as _impl
